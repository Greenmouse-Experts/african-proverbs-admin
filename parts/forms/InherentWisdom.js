...
const InherentWisdom = ({
  ...
  const onSubmit = (data) => {
    ...
    const checkSum = checkInterpretationUniqueness(
      ...
      >
        <DialogContent>
          <ProverbModal
            ...
            name={`${requestType} Inherent Wisdom`}
          >
            <form
              onSubmit={handleSubmit2(
                interpretationData ? onEditFormSubmit : onSubmit
              )}
              noValidate
              autoComplete="off"
              role="form"
            >
              {msg ? <h5 className="text-danger"> {editMsg}</h5> : null}
              <div class="row">
                <div class="col-md-12 mb-1">
                  <label class="control-label">Inherent Wisdom</label>
                  <TextArea
                    name="interpretation"
                    defaultValue={
                      interpretationData ? interpretationData.content : ""
                    }
                    ref={register2({ required: true })}
                  />
                  {errors2.interpretation && (
                ...
                <div class="col-md-12">
                  ...
                  <Select name="languageID" ref={register2({ required: true })}>
                    ...
                    {languages &&
                      languages.map((lang) =>
                        interpretationData &&
                        interpretationData.language.id == lang.id ? (
                ...
                <div class=" col-md-12">
                  ...
                  >
                    {" "}
                    <span>{requestType} Inherent Wisdom</span>{" "}
                  </button>
                </div>
              </div>
            </form>
