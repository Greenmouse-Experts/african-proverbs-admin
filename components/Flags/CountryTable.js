...
const Table = ({
  ...
  useEffect(() => {
    ...
    if (firstUpdate.current) {
      const options = {
        ...
        dom: `<'rt'bottom<"row"<"col"l><"col"p>>>`,
      };

      const tableButtons = $("#datatable-buttons").DataTable(options);
      ...
      const tableButtons1 = $("#datatable-buttons-1").DataTable(options);
  ...
  return (
    <div class="card-box">
      ...
      {headParagraph}
      <div class="table-responsive" style={{ overflowX: "hidden" }}>
        <table
...
// $("#key-table").DataTable({ keys: !0 }), $("#responsive-datatable").DataTable(), $("#selection-datatable").DataTable({ select: { style: "multi" } }),
// $("#key-table").DataTable({ keys: !0 }), $("#responsive-datatable").DataTable(), $("#selection-datatable-1").DataTable({ select: { style: "multi" } }),
